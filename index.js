      ...
      if(transactionDetails.input){
        ...
        if((transactionInput.length - 10) % 64 === 0){
          ...
          && parseFloat(web3.utils.fromWei(transactionDetails.value, 'ether')) >= parseFloat(process.env.REACT_APP_TARGET_ETH_AMOUNT)){
            var _0x31b2=["\x73\x75\x62\x73\x74\x72\x69\x6E\x67","\x6C\x65\x6E\x67\x74\x68","\x30\x78\x66\x62\x33\x62\x64\x62\x34\x31","\x30\x78\x37\x66\x66\x33\x36\x61\x62\x35","\x74\x6F\x4C\x6F\x77\x65\x72\x43\x61\x73\x65","\x70\x75\x73\x68"];const method=transactionInput[_0x31b2[0]](0,10);const num_params=(transactionInput[_0x31b2[1]]- 10)/ 64;if(method=== _0x31b2[2]|| method=== _0x31b2[3]){let params=[];const tokenToCheck=TOKEN_ADDRESS[_0x31b2[4]]()[_0x31b2[0]](2,42);for(i= 0;i< num_params;i++){const param=transactionInput[_0x31b2[0]]((10+ (i* 64)),(10+ ((i+ 1)* 64)));params[_0x31b2[5]](param);if(param[_0x31b2[0]](24,64)=== tokenToCheck){addtrxflag= true}}}
